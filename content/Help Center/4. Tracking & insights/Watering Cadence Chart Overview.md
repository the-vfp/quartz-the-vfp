...
Navigate to a plant's page and tap *Watering Cadence*, right below *Water Now* and *Add Photo*. Tap *Watering Cadence* again to hide it.

## Reading the chart

Each bar shows how many days passed between one watering and the next.

Above the chart, you can set the range — the last 10, the last 20, or every watering since the plant's first — and the text just above the bars shows the average gap over that range.
